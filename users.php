                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <!--    <textarea name="alamat" class="form-control" rows="3" required disabled></textarea> -->
                        </div>
            ...
            <div class="modal-content">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <!-- <label class="form-label">Alamat</label> -->
                            <!--    <textarea name="alamat" id="edit_alamat" class="form-control" rows="3" required disabled></textarea> -->
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Role</label>
                            <select name="level" id="edit_level" class="form-select" required disabled>
                                <option value="Kasir">Kasir</option>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    document.getElementById('edit_level_hidden').value = level;
                });
            });
        });
