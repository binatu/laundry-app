            ...
            <div class="row">
                ...
                <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="about-card">
                        ...
                        <h3>Misi</h3>
                        <p class="about-description">
                            ⁕Memberikan pelayanan laundry yang higienis dan tepat waktu.<br>
                            ⁕Mengutamakan kepuasan pelanggan dengan layanan ramah dan profesional.<br>
                            ⁕Menggunakan teknologi untuk meningkatkan efisiensi dan kualitas layanan.  
                        </p>
                    </div>
                </div>
            </div>
