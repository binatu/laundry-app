...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            ...
            case 'delete':
                $stmt = $pdo->prepare("DELETE FROM paket_laundry WHERE id_paket = ?");
                $stmt->execute([$_POST['id_paket']]);
                break;
        }
...
<body>
                                    ...
                                    <td data-label="Aksi">
                                        <div class="action-buttons">
                                            <button type="button" class="btn btn-sm btn-primary" 
                                                    ...
                                                    data-bs-target="#editPackageModal<?php echo $package['id_paket']; ?>"
                                                    data-id="<?php echo $package['id_paket']; ?>"
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" 
                                                    data-bs-toggle="modal" 
                                                    data-bs-target="#deletePackageModal<?php echo $package['id_paket']; ?>">
    ...
    <div class="modal fade" id="editPackageModal<?php echo $package['id_paket']; ?>" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <?php foreach ($packages as $package): ?>
    <div class="modal fade" id="deletePackageModal<?php echo $package['id_paket']; ?>" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
